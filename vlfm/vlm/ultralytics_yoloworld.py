...
class UltralyticsYOLOWorldITM:
    ...
    def __init__(
        ...
        device: str = "cuda",
        confidence_threshold: float = 0.0001
    ):
        """
    ...
    def _compute_confidence_similarity(self, image_bgr: np.ndarray, txt: str) -> float:
        ...
        print(f"🎯 No confident detections")
        return 0.0
...
if __name__ == "__main__":
    import argparse
    from .server_wrapper import host_model, ServerMixin, str_to_image
    ...
    parser.add_argument("--model", type=str, default="yolov8n-world.pt", 
                       help="YOLO-World model name")
    ...
    # 创建服务器实例
    server = UltralyticsYOLOWorldITMServer(
