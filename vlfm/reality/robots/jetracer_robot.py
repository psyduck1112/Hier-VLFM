...
class JetRacerRobot:
    ...
    def _setup_ros_interface(self, rgb_topic: str, depth_topic: str, cmd_topic: str, odom_topic: str, imu_topic: str):
        """设置ROS订阅和发布"""
        # 订阅传感器数据
    ...
    def is_ready(self) -> bool:
        ...
        return (
            ...
            and rospy.Time.now() - self._last_rgb_time < rospy.Duration(2.0)
            and rospy.Time.now() - self._last_depth_time < rospy.Duration(2.0)
        )
